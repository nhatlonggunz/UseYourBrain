...
namespace UseYourBrainLogicLib.Logic_Components.Tests
{
    ...
    {
        [TestMethod()]
        public void AndConstructorTest()
        {
            And a = new And();
        ...
        [TestMethod()]
        public void AndConstructorTest1()
        {
            ...
            //
            Assert.ThrowsException<ArgumentNullException>(() => new And(null, null));
        }
        ...
        public void toNandTest()
        {
            ...
            And and = new And(A, B);
            Symbol nand = and.toNand();

            Assert.AreEqual("((A % B) % (A % B))", nand.ToString());
        }
